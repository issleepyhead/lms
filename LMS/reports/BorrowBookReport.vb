...
Public Class BorrowBookReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMS.BorrowBookReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBorrowBookReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BorrowBookReport = New BorrowBookReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
